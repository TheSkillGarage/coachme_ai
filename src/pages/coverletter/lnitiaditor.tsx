...
export default function Initiaditor(props: LoadProp) {
    ...
    return (
        <Card hoverable={false} className='flex px-10 flex-col justify-center items-center bg-grey-50 shadow-none border-none rounded-lg  w-full lg:min-h-[80vh] sm:min-h-60'>
            {props?.loading ? <GradientLoader /> : <>
                ...
                <p className='text-grey-300 text-sm text-center sm:mt-4 mt-4'>
